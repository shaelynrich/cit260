...
public class Resource extends Scene{
    ...
    public int hashCode() {
        int hash = 5;
        hash = 71 * hash + (int) (Double.doubleToLongBits(this.amountAvailable) ^ (Double.doubleToLongBits(this.amountAvailable) >>> 32));
        hash = 71 * hash + Objects.hashCode(this.resourceType);
